...
parser.add_argument('--name', required = True, help = "Name of the training job to plot loss of.")

args = parser.parse_args()

data = pd.read_csv(args.name + '/loss_log.txt', sep=" ", skiprows = 1)
